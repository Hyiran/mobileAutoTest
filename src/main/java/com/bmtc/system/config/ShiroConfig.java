...
import com.bmtc.system.shiro.UserRealm;
...
public class ShiroConfig {
	...
	ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/bmtc/**", "anon");
/*		filterChainDefinitionMap.put("/svnUser/**", "anon");
		...
		filterChainDefinitionMap.put("/sys/user/exist", "anon");
